...
const Footer = () => {
  ...
  return (
    <footer className="relative m-auto w-full flex-shrink-0 justify-center bg-white text-center text-sm leading-6 text-gray-600 dark:bg-[#1a191d] dark:text-gray-100">
      {/* 颜色过度区 */}
      <div
        id="color-transition"
