    ...
    <>
      ...
      <nav
        ...
        className={`z-20 h-16 top-0 w-full duration-300 transition-all
            ...
            ${textWhite ? 'text-white' : router.route === '/' ? 'text-white/70 dark:!text-white' : 'text-[#363636] dark:!text-white'}
            ${navBgWhite ? 'bg-white !text-[#363636] dark:bg-[#18171d] shadow' : 'bg-transparent'}`}>
