...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/1a0c05ba848e80329de5f922cff964cf
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '1a0c05ba848e80329de5f922cff964cf,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Passerby', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/images/icon-192x192.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '渝ICP备2025062239号', // 备案号
  BEI_AN_LINK:
